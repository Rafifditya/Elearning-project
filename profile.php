...
<div class="row">
      ...
      <div class="one columns">
			...
			<div class="two columns">
				<img src="<?=$dataMhs['image'];?>" alt="" class="img-circle"/>
				<?php if ($dataMhs['role_id'] == 0) { ?>
					<a href="profile-img.php" class="button" style=""><i class="fa fa-camera-retro fa-lg fa-fw"></i> Ganti profile Picture Anda</a>
					<?php } ?>
			</div>
		</div>
    </div>
