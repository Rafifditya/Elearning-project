		...
		<div class="table-itu">
				...
				<br><br>
				 <div class="docs-example docs-example-forms">
					 <form class="pure-form" action="action-upload.php" method="post" enctype="multipart/form-data">
					 ...
					 <h3><center>file tidak boleh dengan nama sama terimakasih.</center></h3>
				 </div>
    <?php
